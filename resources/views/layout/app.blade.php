...
<html lang="en">
  ...
  <body>
    ...
    <!--   Core JS Files   -->
    <script src="{{ asset('gestion_assets/js/core/jquery-3.7.1.min.js') }} "></script>
    ...
    <!-- jQuery Sparkline -->
    <script src="{{ asset('gestion_assets/js/plugin/jquery.sparkline/jquery.sparkline.min.js') }} "></script>

    <!-- Chart Circle -->
    <script src="{{ asset('gestion_assets/js/plugin/chart-circle/circles.min.js') }} "></script>

    <!-- Datatables -->
    <script src="{{ asset('gestion_assets/js/plugin/datatables/datatables.min.js') }} "></script>

    <!-- Bootstrap Notify -->
    <script src="{{ asset('gestion_assets/js/plugin/bootstrap-notify/bootstrap-notify.min.js') }} "></script>

    <!-- jQuery Vector Maps -->
    <script src="{{ asset('gestion_assets/js/plugin/jsvectormap/jsvectormap.min.js') }} "></script>
